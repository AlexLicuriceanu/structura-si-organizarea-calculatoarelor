...
HD_PWD='C:/Users/Amalia/OneDrive/Desktop/CN/automat/automat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log automat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source automat.tcl -notrace
